	...
	testCases := []testData{
		{
			...
			args:  []string{"testdata/basic/echo.sh", "hello", "world"},
			env:   []string{},
			scmd:  "/bin/echo",
			sargs: []string{"/bin/echo", "testdata/basic/echo.sh", "hello", "world"},
			err:   false,
		},
		{
			name:  "complex",
			cmd:   "testdata/complex/first.sh",
			args:  []string{"testdata/complex/first.sh", "hello", "world"},
			env:   []string{},
			scmd:  "/bin/echo",
			sargs: []string{"/bin/echo", "testdata/basic/echo.sh", "testdata/complex/first.sh", "hello", "world"},
			err:   false,
		},
		{
			name:  "error",
			cmd:   "testdata/error/first.sh",
			args:  []string{"testdata/error/first.sh", "hello", "world"},
			env:   []string{},
			scmd:  "",
			sargs: nil,
			err:   true,
		},
		{
			...
			env:   []string{},
			scmd:  "/bin/echo",
			sargs: []string{"/bin/echo", "hello", "world"},
			err:   false,
		},
	}
